...
async def gen_thumb(videoid):
    try:
        ...
        if 1==1:
            ...
            image4.text((960, 10), "@AloneXBots", fill="white", font = font1, align ="left")
            image4.text((670, 150), "ALONE PLAYING", fill="white", font = font2, stroke_width=2, stroke_fill="red", align ="left") 
