...
def stream_markup_timer(_, videoid, chat_id, played, dur):
    ...
    AloneMusic = math.floor(percentage)
    if 0 < AloneMusic <= 10:
        bar = "⚪─────────"
    elif 10 < AloneMusic < 20:
        bar = "━⚪────────"
    elif 20 <= AloneMusic < 30:
        bar = "━━⚪───────"
    elif 30 <= AloneMusic < 40:
        bar = "━━━⚪──────"
    elif 40 <= AloneMusic < 50:
        bar = "━━━━⚪─────"
    elif 50 <= AloneMusic < 60:
        bar = "━━━━━⚪────"
    elif 60 <= AloneMusic < 70:
        bar = "━━━━━━⚪───"
    elif 70 <= AloneMusic < 80:
        bar = "━━━━━━━⚪──"
    elif 80 <= AloneMusic < 95:
        bar = "━━━━━━━━⚪─"
    else:
        bar = "━━━━━━━━━⚪"
...
def playlist_markup(_, videoid, user_id, ptype, channel, fplay):
    buttons = [
        [
            InlineKeyboardButton(
                text=_["P_B_1"],
                callback_data=f"AloneMusicPlaylists {videoid}|{user_id}|{ptype}|a|{channel}|{fplay}",
            ),
            InlineKeyboardButton(
                text=_["P_B_2"],
                callback_data=f"AloneMusicPlaylists {videoid}|{user_id}|{ptype}|v|{channel}|{fplay}",
            ),
        ],
        [
            InlineKeyboardButton(
